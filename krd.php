...
$sqla="select * from  krc where id=$xgid";
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form  action="krd.php?id=<?php echo $xgid; ?>" method="POST" style="text-align: center" class="bs-example bs-example-form" role="form">
            <div id="login">
                <h2><?php echo $resulta['location']; ?></h2>
                <div class="input-group"><span class="input-group-addon">治愈</span><input name="c" type="text" value="<?php echo $resulta['cu']; ?>" class="form-control"></div><br/>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $cure = $_POST["c"];
    $de = $_POST["e"];
    $sqla="update krc set  cu='{$cure}', de='{$de}'where id={$id}";
    $resa=mysqli_query($dbc,$sqla);
    if($resa==1)
    {
