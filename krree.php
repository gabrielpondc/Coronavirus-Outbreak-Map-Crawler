...
$sqlh="select time,dia,sus,cur,de from  krhistory where id ={$xgid}";
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form  action="krree.php?id=<?php echo $xgid; ?>" method="POST" style="text-align: center" class="bs-example bs-example-form" role="form">
            <div id="login">
                ...
                <div class="input-group"><span class="input-group-addon">现有确诊</span><input name="confirm" type="text" value="<?php echo $resulth['dia']; ?>" class="form-control"></div><br/>
                <div class="input-group"><span class="input-group-addon">新增确诊</span><input name="suspect" type="text" value="<?php echo $resulth['sus']; ?>" class="form-control"></div><br/>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $zy = $_POST["cure"];
    $sw = $_POST["death"];
    $sqla="update krhistory set time='{$riqi}', dia='{$qz}', sus='{$ys}', cur='{$zy}', de='{$sw}'where id={$id}";
